...
## Hackathon Goals (MVP Scope)

### Responsive UI with Amazing UX
- Mobile-first dashboard.
- Clear visualization of whale signals, memes, and capital strategies.

### Working Modules
- Copy Trading (mandatory).
- Meme-Driven Investing (mandatory).
- At least one Capital Sentiment Strategy (bullish, bearish, or volatility).

### Media & Learning
- Short educational videos embedded in the app explaining strategies.
- Simple onboarding for non-technical users.

---

## Success Metrics
- **Engagement:** Number of users connecting wallets and subscribing to signals.
- **Execution:** % of whale trades successfully mirrored.
- **Community Growth:** Meme contributions and sentiment votes.
- **Performance:** Profitability of strategies vs. baseline (HODL).

---

## Future Extensions (Post-Hackathon)
- Token incentives for meme creators and top copy-trading followers.
- Marketplace for whale signal subscriptions.
- Advanced AI sentiment from news + mobile usage data.
- Cross-chain expansion (Solana, Ethereum L2s).
