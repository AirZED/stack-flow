...
export default function SentimentDashboard() {
    ...
    const getSentimentLabel = (score: number) => {
        if (score >= 60) return { label: 'Extremely Bullish', color: 'text-green-400' };
        if (score >= 20) return { label: 'Bullish', color: 'text-green-300' };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Overall Sentiment */}
                <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-white/20 rounded-2xl p-8 mb-8">
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center gap-2 text-sm text-slate-400">
                            <TrendingUp className={`w-4 h-4 ${sentimentData.overallSentiment.trend === 'up' ? 'text-green-400' :
